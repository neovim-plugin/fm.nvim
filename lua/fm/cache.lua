...
-- Map<url, Map<entry name, fm.InternalEntry>>
---@type table<string, table<string, fm.InternalEntry>>
local url_directory = {}

---@type table<integer, fm.InternalEntry>
local entries_by_id = {}
...
---@param name string
---@param type fm.EntryType
---@return fm.InternalEntry
...
---@param url string
---@return table<string, fm.InternalEntry>

...
---@alias fm.Diff fm.DiffNew|fm.DiffDelete|fm.DiffChange

---@class (exact) fm.DiffNew
---@field type "new"
---@field name string
...
---@class (exact) fm.DiffDelete
---@field type "delete"
---@field name string
---@field id integer

---@class (exact) fm.DiffChange
---@field type "change"
---@field entry_type fm.EntryType
---@field name string
---@field column string
...
---@class (exact) fm.ParseError
---@field lnum integer
---@field col integer
---@field message string

---@param bufnr integer
---@return fm.Diff[] diffs
---@return fm.ParseError[] errors Parsing errors
